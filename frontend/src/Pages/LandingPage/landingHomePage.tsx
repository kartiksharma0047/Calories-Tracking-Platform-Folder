...
export default function LandingHomePage() {
  ...
  return (
    <>
      ...
      <div className="landingPage theme-transition container-fluid LandingPagePadding bg-background">
        {/* Section A */}
        <div className="vh-75 fixedBackgroundImage">
          <div className="theme-transition bg-background ms-250px opacity-85 w-30 h-100 text-center d-flex flex-column align-items-center justify-content-center LandingPageTextColor-SectionText">
            ...
            <button className="landingPageSignUpButton fw-light rounded-1 py-2 px-5 border border-1 border-black">
